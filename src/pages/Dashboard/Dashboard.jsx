...
const Dashboard = () => {
  ...
  return (
    <div id='main' className='main-container px-3 px-lg-5 pb-5 pt-0 '>
            ...
            <div className="homeImage w-auto  " >
              <div className="card bg-imp z-1 border border-0 text-white  position-relative h-100 w-auto" >
                ...
                <div className='w-100 h-100  position-absolute bottom-0 p-4 d-flex flex-column gap-col-3'>
                  ...
                  <Link to="/details"><button className='bg-color-blue top-73 left-60 fs-1vmax border-0 text-white px-3 px-lg-4 px-xlg-5 py-2 z-1 position-absolute rounded-pill fw-bold'>Read Now</button></Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className=''>
        <h3 className='fs-29px text-center text-lg-start h-auto w-auto fw-bolder py-4'>Top Rated Comics</h3>
        <div className="container ps-0 h-auto">
          <div className="row h-auto ">
            {
              books.map((data) => (
                <div className="h-auto col-sm-6 col-md-4 col-lg-3 custom-col-4 text-center" key={data.id}>
