...
const Details = () => {
  ...
  const {title,subtitle,chapters,bookId}=state || {};
    ...
    <div id="main" className='main-container invisible-scrollbar px-3 px-sm-5 pb-5 pt-0'>
      <div className='container m-0'>
        <div className='row gap'>
          <div className='col-md-8 p-0'>
            <h1 className='fs-74px text-start fw-bolder fw-bold text-capitalize'>{title}:
              <br />{subtitle}</h1>
      ...
      <div className='h-50  my-3'>
        ...
        <div className='h-auto w-auto container m-0 pb-4'>
          <div className='row'>
            <div className='col-md-5 col-md-2 p-0 fs-2 fw-bolder m-0'>Chapters:<span className='text-color-blue'>{chapters}</span></div>
