...
const Details = () => {
  return (
    <div id="main" className='main-container h-auto w-100 px-3 px-sm-5 pb-5 pt-0'>
      <div className='container h-auto w-100  m-0'>
        <div className='row gap'>
          ...
          <div className='col-md-4 d-block align-items-center text-start  text-lg-end '>
            <div className='h-auto ps-lg-3 ps-xl-3 ms-xl-3 text-start  '>
      ...
      <div className='h-50  my-3'>
        ...
        <div className='h-auto w-auto container m-0 pb-4'>
          <div className='row'>
            <div className='col-md-5 col-md-2 p-0 fs-2 fw-bolder m-0'>Chapters:<span className='text-color-blue'>20</span></div>
